...
class EPPageView extends StatefulWidget {
  ...
  @override
  State<EPPageView> createState() => _PageViewState();
}

class _PageViewState extends State<EPPageView> {
  ...
  @override
  void didUpdateWidget(EPPageView oldWidget) {
      ...
      child: Scrollable(
        ...
        viewportBuilder: (BuildContext context, ViewportOffset position) {
          return Viewport(
            ...
            cacheExtent: widget.allowImplicitScrolling ? widget.cacheExtent : 0.0,
