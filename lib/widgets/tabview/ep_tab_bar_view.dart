...
import 'ep_page_view.dart';

class EPTabBarView extends StatefulWidget {
  ...
  @override
  State<EPTabBarView> createState() => _TabBarViewState();
}

class _TabBarViewState extends State<EPTabBarView> {
  ...
  @override
  void didUpdateWidget(EPTabBarView oldWidget) {
