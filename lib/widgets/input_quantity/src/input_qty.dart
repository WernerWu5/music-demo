...
import 'package:distribution_mall_flutter/widgets/input_quantity/src/floating_point.dart';
import 'package:distribution_mall_flutter/widgets/input_quantity/src/constant.dart';
import 'package:distribution_mall_flutter/widgets/input_quantity/src/decoration_props.dart';
import 'package:distribution_mall_flutter/widgets/input_quantity/src/form_props.dart';
              ...
              case QtyStyle.btnOnLeft:
                final childbtn = [
                  BuildBtn(
                    ...
                    onTap: limitTopState ? plus : () {},
                    disable: limitTopState ? false : true,
                    qtyStyle: widget.decoration.qtyStyle,
                    btnColor: widget.decoration.btnColor,
                    onStart: startTimer,
                    onEndTime: endTimer,
                    orientation: widget.decoration.orientation,
                    iconWidth: widget.decoration.iconWidth,
                    iconHeight: widget.decoration.iconHeight,
                    child: widget.decoration.plusBtn,
                  ),
                  BuildBtn(
                    isPlus: false,
                    borderShape: widget.decoration.borderShape,
                    onTap: limitBtmState ? minus : () {},
                    disable: limitBtmState ? false : true,
                    btnColor: widget.decoration.btnColor,
                    qtyStyle: widget.decoration.qtyStyle,
                    onStart: startTimer,
                    onEndTime: endTimer,
  ...
  Widget _buildtextfield() => TextFormField(
        ...
        onChanged: (String strVal) {
          ...
          if (widget._outputType == _OutputType.integer &&
              strVal.length > 1 &&
              strVal[0] == '0') {
            _valCtrl.text = '${int.tryParse(strVal) ?? 0}';
          }
          ...
          num temp = num.tryParse(strVal) ?? 0;
          // if (temp == null) {
          //   _valCtrl.text = '${currentval.value}';
          //   _valCtrl.selection = TextSelection.fromPosition(
          //       TextPosition(offset: _valCtrl.text.length));
