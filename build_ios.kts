...
// 终端跑 kotlinc -script  build_ios.kts
// shorebird release ios -- --dart-define=env=pro --flavor pro
import java.io.*
...
channelAndFormat.forEach { itemConfig ->
    val buildApp = mutableListOf<String>("shorebird release")
...
println("打包完成")
println(execCmd(arrayOf("open build/ios/archive")))
